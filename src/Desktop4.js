  ...
  return (
    <div className="desktop-4">
     ...
     z
      ...
      <img className="rectangle-icon" alt="" src="../picture/nja logo 1.png" />
      ...
      <br></br>
      <br></br>
      <div className="dotertop mrs respo">
      <Futter/>
    </div>
      </div>
      ...
      {/* <div className="group-div">
        ...
        <img className="vector-icon1" alt="" src="../picture/Vector" />
      </div>
